...
public class ModItems {
    ...
    public static final DeferredItem<Item> FROZEN_TEAR = ITEMS.register("frozen_tear",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> GEM_NODE = ITEMS.register("gem_node",
            () -> new Item(new Item.Properties()));
    ...
    public static final DeferredItem<Item> SOAPSTONE = ITEMS.register("soapstone",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> STRANGE_YELLOW_DOLL = ITEMS.register("stange_yellow_doll",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> STAR_SHARD = ITEMS.register("star_shard",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> STONE = ITEMS.register("stone",
            () -> new Item(new Item.Properties()));
    public static final DeferredItem<Item> STRANGE_GREEN_DOLL = ITEMS.register("strange_green_doll",
            () -> new Item(new Item.Properties()));
